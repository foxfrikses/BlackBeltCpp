...
public:
  ...
  iterator begin() noexcept {return buffer.Data();}
  iterator end() noexcept {return buffer.Data() + sz;}

  const_iterator begin() const noexcept {return buffer.Data();}
  const_iterator end() const noexcept {return buffer.Data() + sz;}

  const_iterator cbegin() const noexcept {return buffer.Data();}
  const_iterator cend() const noexcept {return buffer.Data() + sz;}

  iterator Insert(const_iterator pos, const T& elem) {
    size_t i = pos - cbegin();
    PushBack(elem);
    std::rotate(begin() + i,begin() + sz - 1,begin() + sz);
    return begin() + i;
  }
